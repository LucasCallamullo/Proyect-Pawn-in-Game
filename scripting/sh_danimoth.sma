...
public plugin_init()
{
	...
	pCvarCooldown 		= register_cvar("danimoth_cooldown", 		"45" )		// tiempo de cd
	pCvarFreezeRadius 	= register_cvar("danimoth_freezeradius", 	"750" ) 	// distancia a la que tiene que estar de vos el enemigo para encerrarlo
	pCvarFreezeTime 	= register_cvar("danimoth_freezetime", 		"10.0" )	// tiempo que dura la jaula 
	pCvarPrismLife		= register_cvar("danimoth_prismlife", 		"100" )	// tiempo de vida de la jaula
	pCvarCloakRadius 	= register_cvar("danimoth_radius", 		"750" )	// radio para volver o  volerte invisible
	pCvarCloakPercent 	= register_cvar("danimoth_alpha", 		"130")	// radio para volver invisible a los aliados
...
public sh_hero_init(id, heroID, mode)
{
	...
	switch(mode) {
		case SH_HERO_ADD: {
			...
			sh_chat_message(id, gHeroID, "Nostros sentimos tu presencia..")
		}
		case SH_HERO_DROP: {
