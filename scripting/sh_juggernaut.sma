...
new Float:vecVel[3], fm_PreThink, fm_PreThink_Post
//----------------------------------------------------------------------------------------------
public plugin_init()
{
	// Plugin Info
...
public plugin_end()
{
	if ( fm_PreThink ) unregister_forward(FM_PlayerPreThink, fm_PreThink)
	
	if ( fm_PreThink_Post ) unregister_forward(FM_PlayerPreThink, fm_PreThink_Post, 1)
}
