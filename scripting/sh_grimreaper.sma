...
public plugin_init()
{
	...
	register_cvar("grimreaper_level", "7")
	register_cvar("grimreaper_alpha", "60")
	register_cvar("grimreaper_knifemult", "10.5")
	register_cvar("grimreaper_gravity", "0.25")

	// FIRE THE EVENT TO CREATE THIS SUPERHERO!
	shCreateHero(gHeroName, "Botas Silenciosas/ Gravedad/ daño Faka.", "Invisibilidad/ Mucho daño con la faka/ Menor Gravedad/ Caminar silenciosamente", false, "grimreaper_level")
