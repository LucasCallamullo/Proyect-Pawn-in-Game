...
public plugin_init()
{
	...
	register_cvar("scorpion_cooldown", "4.0")

	// FIRE THE EVENT TO CREATE THIS SUPERHERO!
	shCreateHero(g_heroName, "Get Over Here!", "Apunta tu Harpoon y Atrae a tus enemigos a vos.", true, "scorpion_level")
...
public scorpion_kd()
{
	...
	if ( !is_user_alive(id) || !g_hasScorpionPower[id] || gPlayerUltimateUsed[id] ) return PLUGIN_HANDLED
...
{
	if ( g_hooked[victim] ) scorpion_hookOff(victim)

	if ( g_inKnifeFight[victim] ) scorpion_fight_off(victim)
