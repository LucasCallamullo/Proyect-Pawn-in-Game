...
//Ricochet
ricochet_level 0
ricochet_showrebound 0	//Show rebound sprites
...
public plugin_init()
{
	...
	gPcvarShowRebound = register_cvar("ricochet_showrebound", "0")
	gPcvarExtraDmg = register_cvar("ricochet_extradamage", "5")

	// FIRE THE EVENTS TO CREATE THIS SUPERHERO!
	gHeroID = sh_create_hero(gHeroName, pcvarLevel)
	sh_set_hero_info(gHeroID, "Balas que rebotan.", "Ahora tus balas rebotan contra la pared y causan más daño!")
