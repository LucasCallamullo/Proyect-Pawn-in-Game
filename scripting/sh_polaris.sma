...
public plugin_init()
{
	...
	shCreateHero(gHeroName, "Controlador de Granadas.", "Aleja las granadas que te tiran para poder evitarlas!.", false, "polaris_level" )
...
{
	precache_sound("shmod/polaris.wav")
...
public find_polaris(parm[])
{
	...
	for (new i = 0; i < pnum; i++) {
		...
		if( get_entity_distance(players[i], grenadeID) < gRange ) {
			...
			emit_sound(players[i], CHAN_AUTO, "shmod/polaris.wav", 1.0, ATTN_NORM, 0, PITCH_NORM)
