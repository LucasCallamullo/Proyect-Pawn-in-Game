...
public plugin_init()
{
	...
	sh_set_hero_info(gHeroID, "Team Detección.", "Detecta a tus enemigos con colas rojas que los siguen como rastro.")
}
...
{
	if ( !is_user_alive(id) || !gHasXavier[id] )
		return
...
{
	if ( !is_user_alive(id) || !is_user_alive(player) ) return
