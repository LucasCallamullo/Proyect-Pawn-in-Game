...
public plugin_init()
{
	...
	sh_set_hero_info(gHeroID, "Infecta con Veneno.", "Infecta al enemigo con Balas Envenenadas o Fakasos Envenenados, que reducen su vida gradualmente según su nivel.")
