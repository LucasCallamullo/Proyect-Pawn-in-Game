...
new gPcvarResPct, gPcvarPctLevel, gPcvarGod
...
public plugin_init()
{
	...
	// OK Random Generator
	set_task(5.0, "drstrange_loop", 0, "", 0, "b")
}
...
{
	if ( !is_user_alive(id) || !gHasDrStrangePowers[id] || gLaserShots[id] <= 0 ) return
...
public sh_client_death(victim)
{
	...
	if ( !is_user_alive(victim) && gHasDrStrangePowers[victim] ) {
