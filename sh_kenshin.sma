...
public plugin_init()
{
	...
	sh_set_hero_info(gHeroID, "Bati-CinturÃ³n.", "ObtÃ©n Armas Especiales como SG Teleport/XM1014/FAKA, ademÃ¡s de HP/AP/daÃ±o.")
...
public Batman_heroscheck(id) 
{
	if ( HasFartman[id] && gBatmanSelected[id] ) {
		...
		sh_chat_message(id, gHeroID, " Para usar este HÃ©roe tenes que quitarte el %s primero.", heronametodrop)
      		gHasBatman[id] = false
